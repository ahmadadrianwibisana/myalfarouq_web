  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    ...
    <main class="main">
      ...
      <section
        id="call-to-action"
        class="call-to-action section dark-background">
        <img src="assets/user/img/cta-bg.jpg" alt="" />
          ...
          <div class="row gy-4 align-items-center">
            ...
            <div
              ...
              <div class="position-relative">
                <img
                  src="assets/user/img/profil1.png"
                  class="img-fluid"
                  alt="Profil Image" />
              </div>
            </div>
        ...
        <div class="container">
          <div class="row gy-4">
            <div
              ...
              <div class="card">
                <div class="card-img">
                  <img src="assets/user/img/open1.jpg" alt="" class="img-fluid" />
                </div>
                <p class="card-info">
            ...
            <div
              ...
              <div class="card">
                <div class="card-img">
                  <img src="assets/user/img/open2.jpg" alt="" class="img-fluid" />
                </div>
                <p class="card-info">
            ...
            <div
              ...
              <div class="card">
                <div class="card-img">
                  <img src="assets/user/img/open3.jpg" alt="" class="img-fluid" />
                </div>
                <p class="card-info">
